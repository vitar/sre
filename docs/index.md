...
> The living, latest version of this documentation is always available online: [TC Official Documentation](https://tc.3in3.dev)

---

Every living system — a person, a team, a company, an ecosystem — runs on limited resources. Time, energy, money, attention. There is never enough for everything. So the system makes trade-offs, constantly, whether it knows it or not.
...
The model was built from observing software delivery teams and organizations. It applies wherever three conditions hold: resources are limited, demands compete, and the system changes over time. This turns out to be most living and operational systems — from a single person managing their career to an organization navigating market shifts.
...
Start with [The Model](./110-the-model.md).
